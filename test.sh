...
for ID in 313 315 377 386; do python run.py --type evaluate --cfg_file configs/zju_mocap_exp/latent_xyzc_$ID.yaml exp_name xyzc_$ID eval_whole_img True gpus "0," test_sequence True test.frame_sampler_interval 1; done;
